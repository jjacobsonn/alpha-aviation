  ...
  return (
    <Box sx={{ display: 'flex', minHeight: '100vh' }}>
      ...
      >
                ...
                >
                  <ListItemIcon
                    sx={{
                      ...
                      color: selectedTab === item.id ? item.color : 'text.secondary',
                    }}
                  >
                    {item.icon}
                  </ListItemIcon>
        ...
        <List sx={{ px: 1, py: 2 }}>
          <Tooltip title={!sidebarOpen ? 'Notifications' : ''} placement="right">
            <ListItem disablePadding sx={{ mb: 1 }}>
              <ListItemButton
                sx={{
                  borderRadius: 2,
                      ...
                      <Stack direction="row" spacing={1} alignItems="baseline">
                        ...
                        <Chip 
                          ...
                          sx={{ 
                            height: 20,
                            fontSize: '0.7rem',
                            bgcolor: stat.trend.includes('+') || stat.trend === 'Urgent' ? '#4CAF5020' : '#F4433620',
                            color: stat.trend.includes('+') || stat.trend === 'Urgent' ? '#4CAF50' : '#F44336',
                          }}
                        />
                      </Stack>
                    </Box>
