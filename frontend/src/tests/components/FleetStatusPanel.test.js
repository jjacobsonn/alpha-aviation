...
describe.skip("FleetStatusPanel", () => {
  ...
  test("should display the Fleet Status title", () => {
    render(<FleetStatusPanel />);
  ...
  test("should render all Due Soon aircraft tail numbers", () => {
    render(<FleetStatusPanel />);
  ...
  test("should render the correct number of items in AOG section", () => {
    render(<FleetStatusPanel />);
  ...
  test("should render ListItemButton components for each aircraft", () => {
    render(<FleetStatusPanel />);
