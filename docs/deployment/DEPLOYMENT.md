# Deploy Alpha Aviation on Render (historical)

> **Production is on Railway.** Live URLs, env vars, and deploy steps: [RAILWAY.md](RAILWAY.md).  
> This document is retained as the Render runbook from an earlier deployment.
